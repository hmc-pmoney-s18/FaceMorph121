"""Based out of the route file we see in the tutorial
   this file is a modified version which fit our project"""
import os
import flask
...
@app.route('/')
def index():
    """send the information of our main page"""
...
def upload_file():
    ...
    if request.method == 'POST':
        ...
        if file1 and allowed_file(file1.filename) and file2 and allowed_file(file2.filename):
            ...
            return render_template('displayResult.html', morph=morph_result, \
