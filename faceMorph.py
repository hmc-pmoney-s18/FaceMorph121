...
def morph_triangle(image_1, image_2, img, triangle_1, triangle_2, final_triangle, morphing_rate):
    ...
    img[rectangle[1]:rectangle[1]+rectangle[3], rectangle[0]:rectangle[0]+rectangle[2]] = img[rectangle[1]:rectangle[1]+rectangle[3], rectangle[0]:rectangle[0]+rectangle[2]] *\
